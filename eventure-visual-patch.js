...
const polish=()=>{addStyles();const pc=document.getElementById('publicContent');if(!pc||!pc.children.length)return;if(!pc.querySelector('.eventureShareHero')){const img=document.createElement('img');img.src=HERO;img.alt='Winter Trail Pra Loup — du 11 au 13 décembre 2026';img.className='eventureShareHero';pc.prepend(img)}const box=pc.querySelector('.shareBox');if(box){const h2=box.querySelector('h2');if(h2)h2.textContent='Invite quelqu’un à vivre l’aventure';const meta=box.querySelector('.meta');if(meta){meta.outerHTML='<p class="shareHook">Un week-end à la montagne entre événement et temps libre.</p><p class="shareDate">Du 11 au 13 décembre 2026 à Pra Loup · 3 demi-journées de temps libre.</p>'}}};
const obs=new MutationObserver(()=>polish());obs.observe(document.documentElement,{subtree:true,childList:true});document.addEventListener('DOMContentLoaded',polish);setTimeout(polish,100);setTimeout(polish,700);
